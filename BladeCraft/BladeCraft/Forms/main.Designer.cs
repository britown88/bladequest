namespace BladeCraft
{
    partial class main
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.lvwMaps = new System.Windows.Forms.ListView();
         ...
         this.toolStripStatusLabel1.Text = "BladeCraft";
         // 
         // lvwMaps
         // 
         this.lvwMaps.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
         this.lvwMaps.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
            this.chFileName,
            this.chMapName});
         this.lvwMaps.Cursor = System.Windows.Forms.Cursors.Hand;
         this.lvwMaps.Dock = System.Windows.Forms.DockStyle.Left;
         this.lvwMaps.FullRowSelect = true;
         this.lvwMaps.GridLines = true;
         this.lvwMaps.Location = new System.Drawing.Point(0, 24);
         this.lvwMaps.MultiSelect = false;
         this.lvwMaps.Name = "lvwMaps";
         this.lvwMaps.Size = new System.Drawing.Size(200, 314);
         this.lvwMaps.TabIndex = 7;
         this.lvwMaps.UseCompatibleStateImageBehavior = false;
         this.lvwMaps.View = System.Windows.Forms.View.Details;
         this.lvwMaps.DoubleClick += new System.EventHandler(this.lvwMaps_DoubleClick);
         this.lvwMaps.MouseClick += new System.Windows.Forms.MouseEventHandler(this.lvwMaps_MouseClick);
         // 
         // chFileName
         // 
         this.chFileName.Text = "FileName";
         this.chFileName.Width = 75;
         // 
         // chMapName
         // 
         this.chMapName.Text = "Maps";
         this.chMapName.Width = 125;
         // 
         // mapRightClick
         // 
         this.mapRightClick.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.deleteToolStripMenuItem});
         this.mapRightClick.Name = "contextMenuStrip1";
         this.mapRightClick.Size = new System.Drawing.Size(108, 26);
         // 
         ...
         this.Name = "main";
         this.Text = "BladeCraft - BladeQuest World Designer";
        ...
        private System.Windows.Forms.ListView lvwMaps;
